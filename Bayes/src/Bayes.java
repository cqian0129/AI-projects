...
public class Bayes {
	...
	public void loadTrainingData(String trainingFile) throws IOException
	{
		...
		for (int i = 0; i < numberRecords; i++)
		{
			...
			for (int j = 0; j < numberAttributes; j++)
			{
				...
				attributeArray[j] = convert(label);
			}
	...
	private int convert(String label)
	{
		...
		if (label.equals("0")) value = 1;
		if (label.equals("1")) value = 2;
		if (label.equals("2")) value = 3;
		
		if (label.equals("no")) value = 1;
		if (label.equals("java")) value = 2;
		if (label.equals("hire")) value = 2;
		
		if (label.equals("A")) value = 1;
		if (label.equals("B")) value = 2;
		if (label.equals("C")) value = 3;
		if (label.equals("D")) value = 4;
		
		if (label.equals("other")) value = 1;
		if (label.equals("cs")) value = 2;
